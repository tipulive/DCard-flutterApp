  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        ...
        detailsProfile("Active",Icons.calendar_month_outlined,":5",0xffffffff,"textright",Icons.arrow_forward,"200\$",0xffffffff,Activefunct),//Last Time Purchase
        const SizedBox(height:5,),
        detailsProfile("Reach",Icons.calendar_month_outlined,"6",0xffffffff,"textright",Icons.arrow_forward,"200\$",0xffffffff,Reachedfunct),//Last Time Purchase
        const SizedBox(height:5,),
        detailsProfile("All Events",Icons.account_balance_wallet,"${(Get.put(TopupQuery()).obj)["resultData"]["result"][0]["balance"]}\$",0xffffffff,"textright",Icons.arrow_forward,"200\$",0xffffffff,AllEventfunct),
